                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 cursor-pointer"
                            >
                                <optgroup label="🔥 Gemini (via ProxyPal OAuth)">
                            ...
                            <Show when={settings().model === "custom"}>
                                <input
                                    ...
                                    class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 mt-2"
